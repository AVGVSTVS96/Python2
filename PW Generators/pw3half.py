...
def generate_password():
  ...
  if side == 'left':
    choices = [key for key in choices if key in ['q', 'w', 'e', 'r', 't', 'a', 's', 'd', 'f', 'g', 'z', 'x', 'c', 'v', 'b', 'Q', 'W', 'E', 'R', 'T', 'A', 'S', 'D', 'F', 'G', 'Z', 'X', 'C', 'V', 'B', '5', '4', '3', '2', '1', '%', '$', '#', '@', '!']]
  elif side == 'right':
    choices = [key for key in choices if key in ['y', 'u', 'i', 'o', 'p', 'h', 'j', 'k', 'l', 'n', 'm', 'Y', 'U', 'I', 'O', 'P', 'H', 'J', 'K', 'L', 'N', 'M', '6', '7', '8', '9', '0', '^', '&', '*', '(', ')', '-', '_', '=', '+', '[', '{', ']', '}', ';', ':', '\'', ',', '<', '.', '>', '/', '?']]
